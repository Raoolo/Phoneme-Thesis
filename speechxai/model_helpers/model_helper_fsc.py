...
class ModelHelperFSC:
    """
    Wrapper class to interface with HuggingFace models. Provides methods for predicting and
    extracting information from the FSC model, which predicts actions, object and location
    """
    ...
    def predict(
        ...
        for e, audio in enumerate(audios):
            ...
            # Debug print
            # print(f"Predicted action probs: {action_probs[e]}")
            # print(f"Predicted object probs: {object_probs[e]}")
            # print(f"Predicted location probs: {location_probs[e]}")
